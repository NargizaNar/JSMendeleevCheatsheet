...
function evaluate(inputStr) {
    switch (true) {
        ...
        //     return "./2Strings/2string3Boolean.md", see 3boolean2String.md
        ...
        //moved to Array + Replace now: case inputStr === "array+Add" || inputStr === "Add+array":
        ...
        //moved to Class + Replace case inputStr === "class+add" || inputStr === "add+class":
          //  return "./7Classes/7classAdd.md";
       // see below - case inputStr === "class+info" || inputStr === "info+class":
        case inputStr === "class":
        ...
        //moved to Object+Replace : case inputStr === "object+add" || inputStr === "add+object":
        ...
        // moved to NaN info: case inputStr === "typeof":
